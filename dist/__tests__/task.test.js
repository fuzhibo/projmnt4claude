...
describe('displayCheckpointVerificationWarnings', () => {
    let displayCheckpointVerificationWarnings;
    let consoleSpy;
    beforeEach(async () => {
        const mod = await taskModule();
...
describe('displayCheckpointCreationWarning', () => {
    let displayCheckpointCreationWarning;
    let consoleSpy;
    beforeEach(async () => {
        const mod = await taskModule();
...
describe('generateCheckpointTemplate', () => {
    let generateCheckpointTemplate;
    let env;
    let consoleSpy;
    let taskSpy;
    const mockTask = {
...
describe('createTask', () => {
    ...
    let consoleErrorSpy;
    let taskExistsSpy;
    let generateNewTaskIdSpy;
    let writeTaskMetaSpy;
    let syncCheckpointsSpy;
    beforeEach(async () => {
        const mod = await taskModule();
