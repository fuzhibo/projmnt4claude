...
function initProject(cwd) {
    ...
    fs.writeFileSync(path.join(cwd, '.projmnt4claude', 'config.json'), JSON.stringify({ analyze: { autoGenerateCheckpoints: true } }), 'utf-8');
}
function readTaskFromDisk(cwd, taskId) {
