...
import { createDefaultSprintContract, createDefaultDevReport, createDefaultExecutionRecord, } from '../types/harness.js';
...
function createTestSummary(overrides = {}) {
...
describe('HarnessReporter: formatSummaryReport', () => {
    ...
    test('includes statistics overview with correct values', () => {
        ...
        const report = reporter.formatSummaryReport(summary);
...
describe('HarnessReporter: formatTaskOverview', () => {
    ...
    test('includes task metadata (title, type, priority, status)', () => {
        ...
        const overview = reporter.formatTaskOverview(record);
