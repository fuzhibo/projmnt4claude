...
describe('updateTaskStatus', () => {
    ...
    it('auto-completes pending checkpoints on resolve', async () => {
        ...
        writeTaskMeta(makeTask({
            ...
            status: 'in_progress',
            checkpoints: [
                { id: 'CP-001', description: 'A', status: 'completed', createdAt: '2020-01-01T00:00:00.000Z', updatedAt: '2020-01-01T00:00:00.000Z', verification: { method: 'automated' } },
...
describe('buildTaskVerification', () => {
    it('passed when all checkpoints completed', async () => {
        ...
        const task = makeTask({
            checkpoints: [
                { id: 'CP-001', description: 'A', status: 'completed', createdAt: '2020-01-01T00:00:00.000Z', updatedAt: '2020-01-01T00:00:00.000Z', verification: { method: 'unit_test' } },
            ],
        });
...
describe('recordExecutionStats', () => {
    ...
    it('records stats', async () => {
        ...
        writeTaskMeta(makeTask({ id: 'TASK-001' }), env.tempDir);
        const stats = { duration: 5000, retryCount: 2, completedAt: new Date().toISOString() };
