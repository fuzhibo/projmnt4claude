...
import { detectOperationSource, getExecutionContext, getBatchUpdateLogPath, writeBatchUpdateLog, readBatchUpdateLogs, formatLogEntry, queryBatchUpdateLogs, formatLogList, showLogSummary, } from '../batch-update-logger';
...
describe('Batch Update Logger', () => {
    ...
    describe('queryBatchUpdateLogs', () => {
        ...
        it('应该支持按时间范围过滤', () => {
            ...
            const logs = queryBatchUpdateLogs({ startTime, endTime }, TEST_DIR);
            expect(Array.isArray(logs)).toBe(true);
        });
    });
