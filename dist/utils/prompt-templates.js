 ...
 */
export const DEFAULT_DEV_TEMPLATE = `# 任务: {title}
 ...
 */
export const DEFAULT_CODE_REVIEW_TEMPLATE = `# 代码审核任务
 ...
 */
export const DEFAULT_QA_TEMPLATE = `# QA 验证任务
 ...
 */
export const DEFAULT_EVALUATION_TEMPLATE = `# 架构评估任务
 ...
 */
export const DEFAULT_REQUIREMENT_TEMPLATE = `你是一个项目管理助手。根据以下需求描述，提取结构化元数据。
 ...
 */
export const DEFAULT_CHECKPOINTS_TEMPLATE = `你是一个项目管理助手。为以下任务生成检查点列表。
 ...
 */
export const DEFAULT_QUALITY_TEMPLATE = `你是一个项目质量审查助手。评估以下任务的质量。
 ...
 */
export const DEFAULT_DUPLICATES_TEMPLATE = `你是一个项目管理助手。检测以下任务列表中的语义重复。
 ...
 */
export const DEFAULT_STALENESS_TEMPLATE = `你是一个项目管理助手。评估以下任务是否陈旧。
 ...
 */
export const DEFAULT_DECOMPOSITION_TEMPLATE = `你是一个专业的需求/问题分析专家。
 ...
 */
export const DEFAULT_BUG_REPORT_TEMPLATE = `你是一个 Bug 分析助手。将以下 Bug 报告转为结构化需求文档。
 ...
 */
export const DEFAULT_SEMANTIC_DEPENDENCY_TEMPLATE = `你是一个项目管理助手。分析以下任务列表，推断任务间的语义依赖关系。
 ...
 */
export function loadPromptTemplate(name, cwd) {
