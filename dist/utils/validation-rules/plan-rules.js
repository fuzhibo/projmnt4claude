 ...
 */
export const semanticDepsRequiredFields = {
 ...
 */
export const semanticDepsArrayType = {
    id: 'semantic-deps-array-type',
    description: 'dependencies 必须是数组类型',
    severity: 'warning',
    check: (output) => {
        const parsed = safeParseJson(output);
        if (!parsed || !('dependencies' in parsed))
            return null;
...
export const semanticDepsItemStructure = {
    ...
    check: (output) => {
        ...
        for (let i = 0; i < parsed.dependencies.length; i++) {
            ...
            for (const field of ['taskId', 'depTaskId', 'reason']) {
 ...
 */
export const semanticDepsNoSelfRef = {
 ...
 */
export const semanticDepsCountControl = {
 ...
 */
export const semanticDepsReasonMinLength = {
...
export const semanticDependencyOutputRules = [
