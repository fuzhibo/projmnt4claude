 ...
 */
function stripSectionHeaders(content) {
    let cleaned = content;
 ...
 * @returns 矛盾检测结果
 */
export function detectContradiction(resultLabel, content) {
 ...
 */
export function qualityScoreToVerdict(score, minScore = 60) {
 ...
 */
export function getQualityMinScore(cwd) {
    try {
        // 延迟导入避免循环依赖
