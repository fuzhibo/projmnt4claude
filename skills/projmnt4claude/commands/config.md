...
# 获取特定配置
node ${CLAUDE_PLUGIN_ROOT}/dist/projmnt4claude.js config get language

# 修改配置
node ${CLAUDE_PLUGIN_ROOT}/dist/projmnt4claude.js config set language en
```
...
**示例:**
```bash
projmnt4claude config set logging.level debug
projmnt4claude config set logging.recordInputs true
projmnt4claude config set logging.inputMaxLength 500
```
